...
int main()
{
    ...
    k2d::Texture* lightTexture =
        assets.LoadTexture("light_cookie", "assets/2d_lights_and_shadows_neutral_point_light.png");
    if (!lightTexture)
        lightTexture = assets.LoadTexture("light_cookie", "../../assets/2d_lights_and_shadows_neutral_point_light.png");
    if (lightTexture)
    ...
    const Math::Vec2 creaturePositions[4] = {Math::Vec2(480.0f, 320.0f), Math::Vec2(800.0f, 300.0f),
    ...
    const Math::Vec2 markerPositions[14] = {
        Math::Vec2(120.0f, 90.0f),  Math::Vec2(260.0f, 60.0f),  Math::Vec2(430.0f, 130.0f), Math::Vec2(620.0f, 70.0f),
        Math::Vec2(920.0f, 90.0f),  Math::Vec2(1120.0f, 60.0f), Math::Vec2(160.0f, 300.0f), Math::Vec2(300.0f, 440.0f),
        Math::Vec2(620.0f, 250.0f), Math::Vec2(690.0f, 400.0f), Math::Vec2(950.0f, 260.0f), Math::Vec2(1090.0f, 420.0f),
    ...
    for (int i = 0; i < 14; ++i)
    {
        ...
        Math::Vec2 square[4] = {Math::Vec2(-14.0f, -14.0f), Math::Vec2(14.0f, -14.0f), Math::Vec2(14.0f, 14.0f),
                                Math::Vec2(-14.0f, 14.0f)};
    ...
    const LightSetup lightSetups[4] = {{Math::Vec2(280.0f, 620.0f), Math::Vec3(1.0f, 0.55f, 0.15f), 620.0f},
