...
class SpriteComponent : public Component
{
  public:
    ...
    const Material2D& material() const
    {
        return mMaterial;
    }
    ...
    void setRenderOffset(const Math::Vec2& offset)
    {
        mRenderOffset = offset;
    }
    const Math::Vec2& renderOffset() const
    {
    ...
    {
        return mMaterial.tiling();
    }
    void setLightMask(unsigned int mask)
    {
        mMaterial.setLightMask(mask);
    }
    unsigned int lightMask() const
    {
        return mMaterial.lightMask();
    }
    ...
    {
        return mMaterial.normalMap();
    }
    void setCustomShader(unsigned int program)
    {
        mMaterial.setCustomShader(program);
    }
    unsigned int customShader() const
    {
        return mMaterial.customShader();
    }
    void setWaterEnabled(bool enabled)
    {
        mMaterial.setWaterEnabled(enabled);
    }
    bool waterEnabled() const
    {
        return mMaterial.waterEnabled();
    }
    WaterEffect& water()
    {
        return mMaterial.water();
    }
    ...
    bool flipX() const
    {
        return mMaterial.flipX();
    }
    bool flipY() const
    {
        return mMaterial.flipY();
    }
