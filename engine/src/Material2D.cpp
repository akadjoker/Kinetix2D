...
Material2D::Material2D()
    : mTexture(nullptr), mColor(1.0f), mSourceRect(0.0f), mTiling(1.0f, 1.0f), mPivot(0.5f), mBlendMode(BLEND_MIX),
      mHasSourceRect(false), mFlipX(false), mFlipY(false), mLightMask(1), mNormalMap(nullptr), mCustomShader(0),
      mWater()
{
}

void Material2D::setColor(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
{
