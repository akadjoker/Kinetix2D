...
int main()
{
    ...
    material.setPivot(glm::vec2(0.0f, 1.0f));
    ...
    bool atlas = material.hasSourceRect() && material.sourceRect() == glm::vec4(16.0f, 8.0f, 32.0f, 24.0f);
    bool state = material.pivot() == glm::vec2(0.0f, 1.0f) && material.flipX() &&
                 !material.flipY() && material.blendMode() == k2d::BLEND_ADD;
    material.clearSourceRect();
    bool clear = !material.hasSourceRect() && material.sourceRect() == glm::vec4(0.0f);
